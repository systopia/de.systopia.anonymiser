...
// Make CRM_Anonymiser_ExtensionUtil available.
require_once __DIR__ . '/../../anonymiser.civix.php';
...
addExtensionToClassLoader('de.systopia.anonymiser');
 ...
 */
function _anonymiser_test_civicrm_container(ContainerBuilder $container): void {
}
